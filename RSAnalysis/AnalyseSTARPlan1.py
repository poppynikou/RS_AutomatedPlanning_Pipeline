...
GSTT_Patients = ['GSTT_HN_1','GSTT_HN_10','GSTT_HN_15','GSTT_HN_5','GSTT_HN_7']
Patients = UCLH_Patients + GSTT_Patients
...
# calc % of patients with Star plan which adhered to all nominal criteria  
# for all structures
total = 0
for patient in Patients:
    if np.sum(results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient))]['Nominal_Pass_Rate'].tolist()) == No_Structures:
        total = total +1 
...
for patient in Patients:
    ...
    if np.sum(results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) ][4:8]['Nominal_Pass_Rate'].tolist()) == No_CTV_Stuctures:
        total = total +1 

    else:
        Difference = 5850- results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient))]['Dose_Nominal'].tolist()[4]
        CTV_HIGH_D99.append(np.abs(Difference)/100)
        Difference = 6180 - results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient))]['Dose_Nominal'].tolist()[5]
        CTV_HIGH_D95.append(np.abs(Difference)/100)
        Difference = 4860 - results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient))]['Dose_Nominal'].tolist()[6]
        CTV_LOW_D99.append(np.abs(Difference)/100)
        Difference = 5130 - results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient))]['Dose_Nominal'].tolist()[7]
...
for patient in Patients:
    ...
    if np.sum(results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) ][0:2]['Nominal_Pass_Rate'].tolist()) == No_Serial_OARs:
        total = total +1 

    else:
        Difference = 5400- results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient))]['Dose_Nominal'].tolist()[0]
        BRAINSTEM.append(np.abs(Difference)/100)
        Difference = 4800 - results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient))]['Dose_Nominal'].tolist()[1]
...
for patient in Patients:
    ...
    if np.sum(results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) ][2:4]['Nominal_Pass_Rate'].tolist()) == No_Parallel_OARs:
        total = total +1 

    else:
        Difference = 2400- results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient))]['Dose_Nominal'].tolist()[2]
        PAROTIDL.append(np.abs(Difference)/100)
        Difference = 2400 - results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient))]['Dose_Nominal'].tolist()[3]
...
print('---Robustness Star Plan ALL ---')
Robustness100 = 0
Robustness95 = 0
Robustness90 = 0
for patient in Patients:
    if len(results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Robustness_Pass_Rate'] == 100)]['Structure'].tolist()) == No_Structures:
        Robustness100 = Robustness100 +1 
    if len(results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Robustness_Pass_Rate'] > int(95))]['Structure'].tolist()) == No_Structures:
        Robustness95 = Robustness95 +1 
    if len(results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Robustness_Pass_Rate'] > int(90))]['Structure'].tolist()) == No_Structures:
...
Robustness90 = 0
for patient in Patients:
    Pass_structures = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Robustness_Pass_Rate'] == 100)]['Structure'].tolist()
    CTV_Pass_Structures = [structure for structure in Pass_structures if structure[0:8] == 'CTV_HIGH']
    if len(CTV_Pass_Structures) == 2:
        Robustness100 = Robustness100 + 1
    Pass_structures = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Robustness_Pass_Rate'] > int(95))]['Structure'].tolist()
    CTV_Pass_Structures = [structure for structure in Pass_structures if structure[0:8] == 'CTV_HIGH']
    if len(CTV_Pass_Structures) == 2:
        Robustness95 = Robustness95 + 1 
    Pass_structures = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Robustness_Pass_Rate'] > int(90))]['Structure'].tolist()
    CTV_Pass_Structures = [structure for structure in Pass_structures if structure[0:8] == 'CTV_HIGH']
    if len(CTV_Pass_Structures) == 2:
        Robustness90 = Robustness90 + 1 
...
for patient in Patients:
    ...
    WorstCase_CTVHIGHD99 = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Structure'] == 'CTV_HIGH_D99') & (results['Robustness_Pass_Rate'] != 100)]['Worst_Case_Scenario'].tolist()
    if len(WorstCase_CTVHIGHD99) != 0:
        Difference_CTVHIGHD99.append(np.absolute(5850 - WorstCase_CTVHIGHD99[0])/100)
    WorstCase_CTVHIGHD95 = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Structure'] == 'CTV_HIGH_D95') & (results['Robustness_Pass_Rate'] != 100)]['Worst_Case_Scenario'].tolist()
    if len(WorstCase_CTVHIGHD95) != 0:
        Difference_CTVHIGHD95.append(np.absolute(6180 - WorstCase_CTVHIGHD95[0])/100)
    WorstCase_CTVLOWD99 = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Structure'] == 'CTV_LOW_D99') & (results['Robustness_Pass_Rate'] != 100)]['Worst_Case_Scenario'].tolist()
    if len(WorstCase_CTVLOWD99) != 0:
        Difference_CTVLOWD99.append(np.absolute(6180 - WorstCase_CTVLOWD99[0])/100)
    WorstCase_CTVLOWD95 = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Structure'] == 'CTV_LOW_D95') & (results['Robustness_Pass_Rate'] != 100)]['Worst_Case_Scenario'].tolist()
...
for patient in Patients:
    ...
    WorstCase_BS = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Structure'] == 'BRAINSTEM') & (results['Robustness_Pass_Rate'] != 100)]['Worst_Case_Scenario'].tolist()
    if len(WorstCase_BS) != 0:
        Difference_BS.append(np.absolute(5400 - WorstCase_BS[0])/100) 
    WorstCase_SC = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Structure'] == 'CORD') & (results['Robustness_Pass_Rate'] != 100)]['Worst_Case_Scenario'].tolist()
...
for patient in Patients:
    ...
    WorstCase_PAROTIDR = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Structure'] == 'PAROTIDR') & (results['Robustness_Pass_Rate'] != 100)]['Worst_Case_Scenario'].tolist()
    if len(WorstCase_PAROTIDR) != 0:
        Difference_PAROTIDR.append(np.absolute(2400 - WorstCase_PAROTIDR[0])/100)
    WorstCase_PAROTIDL = results.loc[(results['Plan'] == 'STAR') & (results['Patient'] == str(patient)) & (results['Structure'] == 'PAROTIDL') & (results['Robustness_Pass_Rate'] != 100)]['Worst_Case_Scenario'].tolist()
...
# calc % of patients with Star plan which adhered to robustness criteria at > 95% 
# calc % of patients with Star plan which adhered to robustness criteria at > 90%
print('---Robustness Star Plan GSTT ---')
Robustness100 = 0
Robustness95 = 0
Robustness90 = 0
for patient in GSTT_Patients:
...
# calc % of patients with Star plan which adhered to robustness criteria at > 95% 
# calc % of patients with Star plan which adhered to robustness criteria at > 90%
print('---Robustness Star Plan UCLH ---')
Robustness100 = 0
Robustness95 = 0
Robustness90 = 0
for patient in UCLH_Patients:
